...
def main():
    ...
    # This is for theatre_two. Hoping there is an easier way to do this then 
    # just copying the whole script and pasting it down below? 
    # But for now it works.
    
    
    
    soup = BeautifulSoup(urllib2.urlopen(theatre_two), 'html.parser') 
